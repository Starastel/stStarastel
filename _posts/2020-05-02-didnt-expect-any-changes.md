...
- Перерисованы фоны, указывающие текущий игровой день для русского и английского языков. Для первого [выглядит он так](/images/days_of_week.webp). Учитывайте, что в игре он хранится при 100% качестве сжатия с потерями.
...
Таки да, моя цель чтобы «сайт работал в большинстве, и даже старых, браузерах» уже не актуальна. Посмотрите внимательно на [это изображение](/images/days_of_week.webp). Если оно у вас не отображается, значит у вас либо старый браузер, либо ваш текущий просто не умеет отображать анимированный «webp» или не умеет отображать его в принципе.
