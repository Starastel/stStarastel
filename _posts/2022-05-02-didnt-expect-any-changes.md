...
### Пример:
![](/images/days_of_week.webp){:width="240"}{:.il} Учитывайте, что в игре они хранится при 100% качестве сжатия с потерями.
